...
ROOT_DIR="${HOME}/qgrasping_state/${ENV}/${RANDOM_TYPE}_${DIR_SUFFIX}"
...
GINCONFIG="
$(cat "${BASE_DIR}/configs/${ENV}/grasping_env_state.gin")
$(cat "${BASE_DIR}/configs/${ENV}/run_random_state.gin")
